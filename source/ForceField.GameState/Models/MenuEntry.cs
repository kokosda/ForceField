...
namespace ForceField.GameState.Models
{
    public class MenuEntry
    {
        ...
        public virtual void Draw(GameScreen screen, bool isSelected, GameTime gameTime)
        {
            ...
            ScreenManager screenManager = screen.GameScreenServiceImpl.ScreenManager;
        ...
        {
            return screen.GameScreenServiceImpl.ScreenManager.Font.LineSpacing;
        }
        ...
        {
            return (int)screen.GameScreenServiceImpl.ScreenManager.Font.MeasureString(Text).X;
        }
